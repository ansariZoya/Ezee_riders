      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              Text("Earning of this week", style: AppTextStyles.baseStyle2.copyWith(color: AppColors.blackColor,fontSize: 16),),
              Text("₹477.98", style:AppTextStyles.baseStyle2.copyWith(color: AppColors.blackColor,fontSize: 16),)
            ],
          ),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
